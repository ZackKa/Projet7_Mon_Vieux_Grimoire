...
app.use((req, res, next) => {
	...
	res.setHeader("Access-Control-Allow-Methods","GET, POST, PUT, DELETE");//On donne l'autorisation de certaines methods.
	next();
});
...
app.use('/images', express.static(path.join(__dirname, 'images')));//On récupère le répertoire où s'exécutent le serveur et y on concatène le répertoire images
